...
const projectId = "myfundi-10db8"; // Defined from your firebaseConfig
...
if (!admin.apps.length) {
  ...
  try {
    adminApp = admin.initializeApp({
      ...
      projectId: projectId, // Explicitly provide projectId
    });
    ...
    if (adminApp) {
        ...
        try {
            ...
            adminDbInstance = null; // Ensure it's null on error
        }
        ...
        try {
            ...
            adminAuthInstance = null; // Ensure it's null on error
        }
    ...
    adminApp = null; // Ensure app is null on error
...
export const AdminTimestamp = admin.firestore.Timestamp; // This can be accessed statically from admin.firestore
export const AdminFieldValue = admin.firestore.FieldValue; // This can be accessed statically from admin.firestore
